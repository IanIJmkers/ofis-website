  ...
  return (
    <div className="bg-white rounded-lg shadow-card overflow-hidden flex flex-col animate-pulse">
      ...
      <div className="p-8 flex flex-col flex-1">
        ...
        <div className="h-4 w-full bg-warm-gray-100 rounded mb-2" />
        <div className="h-4 w-full bg-warm-gray-100 rounded mb-2" />
        <div className="h-4 w-2/3 bg-warm-gray-100 rounded mb-6" />
        <div className="mt-auto h-4 w-24 bg-warm-gray-200 rounded" />
      </div>
    </div>
  );
}
    ...
    <PageTransition>
      ...
      <SectionWrapper bg="cream" size="lg">
        ...
        {loading ? (
          ...
          <p className="mt-16 text-center text-warm-gray-500">
                ...
                <div className="p-8 flex flex-col flex-1">
                  ...
                  <div className="mt-auto">
                    <Link
                      ...
                      className="inline-flex items-center gap-2 text-xs font-body font-semibold tracking-wider uppercase text-gold-700 group-hover:text-gold-600 transition-colors duration-200"
                    >
                      Lees meer
                      <svg
