...
export default function Footer() {
  ...
  const legalLinks = [
    { label: t("footer", "termsOrchestra"), src: "/docs/voorwaarden-orchestra-bv.pdf" },
    { label: t("footer", "termsGA"), src: "/docs/voorwaarden-orchestra-ga.pdf" },
    { label: t("footer", "termsMyOrchestra"), src: "/docs/voorwaarden-myorchestra.pdf" },
    { label: t("footer", "privacyCookie"), src: "/docs/privacy-cookieverklaring.pdf" },
    { label: t("footer", "sustainability"), src: "/docs/duurzaamheid.pdf" },
    { label: t("footer", "remuneration"), src: "/docs/beloningsbeleid.pdf" },
  ];
